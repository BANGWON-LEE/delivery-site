...
<body>
    <div class="left_menu">
        ...
        <ul class="menu_list">
            <li class="main_menu"><img src="./images/book.png" alt="책"><span onclick="print_sublist()">My page</span>
                <ul class="sub_list">
					<li class="sub_menu" onclick="chagesrc('k')">-내정보</li>
            ...
            function chagesrc(i){
                ...
                switch(i){
                    ...
                    case 'f':
                        ...
                        break; 
                    case 'k':
                    	iframe1.setAttribute('src','./mypage_user_info.jsp?u_code=<%=u_code%>');
                    default:
                }
    ...
    <div class="right_menu">
        <iframe id="the_iframe" src="mypage_user_info.jsp?u_code=<%=u_code%>" name="the_iframe" frameborder="0"></iframe>
    </div>
</body>
